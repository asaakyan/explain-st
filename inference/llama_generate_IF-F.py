...
def main():
    ...
    dir_of_hf_w = f"/mnt/swordfish-pool2/asaakyan/style-transfer/alpaca-informal-formal-noexpl/"
    out_dir = "../../data/gyafc_w_ICHF_alpaca/informal_to_formal"
    assert os.path.isdir(out_dir)
    # input_json = "../../data/gyafc_w_ICHF_alpaca/informal_to_formal/test.json"
    input_json = "../../data/gyafc_w_ICHF_alpaca/informal_to_formal/test_noexpl.json"
    assert os.path.isfile(input_json)
    model_name = "alpaca_noexpl"
    load_in_8bit = False
    stop_idx = 10000
